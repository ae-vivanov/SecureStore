...
namespace Tests
{
    ...
    public class FunctionalityTests
    {
        ...
        public async Task StoreAndLoadKeyFromStreamAsync()
        {
            ...
            await using var storeStream = new FileStream(storePath, FileMode.Open, FileAccess.Read);
            await using var keyStream = new FileStream(keyPath, FileMode.Open, FileAccess.Read);
            using var sman = SecretsManager.LoadStore(storeStream);
